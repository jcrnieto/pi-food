...
const getAllRecipes = async (req, res, next) => {
    ...
    try{
   const apiInfo= /*recetas; */await axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=a4dc6a2f73364e3d8138298979fc281a&addRecipeInformation=true&number=100`)
...
const getIdRecipes = async (req, res, next) => {
    ...
    try{
    const apiInfo= await axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=a4dc6a2f73364e3d8138298979fc281a&addRecipeInformation=true&number=100`) 
