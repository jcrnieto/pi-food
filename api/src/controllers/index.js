...
const getAllRecipes = async (req, res, next) => {
    ...
    try{
   const apiInfo= /*recetas; */await axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=922adc339a584c67a03510db6e01cd48&addRecipeInformation=true&number=100`)
...
const getIdRecipes = async (req, res, next) => {
    ...
    try{
    const apiInfo= await axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=922adc339a584c67a03510db6e01cd48&addRecipeInformation=true&number=100`) 
